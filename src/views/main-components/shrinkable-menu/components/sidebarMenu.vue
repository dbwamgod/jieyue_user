...
<template>
    <Menu ref="sideMenu" :active-name="activeName" :open-names="['1']" :theme="menuTheme" width="auto"
        ...
        <Submenu name="1">
            ...
            <MenuItem :name="menuActiveName[index]" class="menu-title-flag" v-if="menuDisplay[code[index]]"
                      v-for="(item,index) in dynamicMenu.textMenu" :key="index">
        ...
        methods: {
            ...
            menuSelect (name) {
                let pathName = {
                    ...
                    '1-1':"tenant_index",
                    '1-3':"resource_index",
                    '1-4':"accesstest_index",
                    '1-5':"access_index",
                    '1-6':"oauth_index",
                };
                this.$router.push({name:pathName[name]})
